...
def getNotification():
    ...
    base_Url = "http://api.openweathermap.org/data/2.5/weather?"  # base url from where we extract weather report
    try:
        # This is the complete url to get weather conditions of a city
        complete_url = base_Url + "appid=" + 'd850f7f52bf19300a9eb4b0aa6b80f0d' + "&q=" + cityName
...
# Heading label
Label(wn, text="PINK'S Weather Desktop Notifier", font=('Courier', 15), fg='grey19', bg='azure').place(x=100, y=15)
